            ...
            <div className='border-main rounded-[10px] bg-[white]'>
                ...
                <div className="p-10 flex-row m-auto bg-[white] w-350 text-14 text-main rounded-md">
                        <div className='m-10 mb-30'>
                            <div className='flex justify-center w-full p-3 m-5 font-bold rounded-md text-16'>식품명</div>
                            <hr></hr>
                            <div className='flex justify-center'>
                                {foodNames.map((value, idx) => (
                                    <span className='m-5 text-center text-info_s w-[50%]' key={idx}>{value}</span>
                                ))}
                            </div>
                        </div>
                        <div className='m-10 mb-30'>
                            <div className='flex justify-center w-full p-3 m-auto font-bold rounded-md text-16'>회사명</div>
                            <hr></hr>
                            <div className='flex justify-center'>    
                                {companyNames.map((name, idx) => (
                                    <span className='m-5 text-center text-info_s w-[50%]' key={idx}>{name}</span>
                                ))}
                            </div>
                        </div>
                        <div className='m-10 mb-30'>
                            <div className='flex justify-center w-full p-3 m-auto font-bold rounded-md text-16'>총 사이즈</div>
                            <hr></hr>
                            <div className='flex justify-center'>    
                        ...
                        <div className='m-10 mb-30'>
                            <div className='flex justify-center w-full p-3 m-5 font-bold rounded-md text-16'>탄수화물</div>
                            <hr></hr>
                            <div className='flex justify-center'>
                        ...
                        <div className='m-10 mb-30'>
                            <div className='flex justify-center w-full p-3 m-5 font-bold rounded-md text-16'>단백질</div>
                            <hr></hr>
                            <div className='flex justify-center'>
                        ...
                        <div className='m-10 mb-30'>
                            <div className='flex justify-center w-full p-3 m-5 font-bold rounded-md text-16'>지방</div>
                            <hr></hr>
                            <div className='flex justify-center'>
                                {fats.map((name, idx) => (
                                    <span className='m-5 text-center text-info_s w-[50%]' key={idx}>{name}g</span>
                        ...
                        <div className='m-10 mb-30'>
                            <div className='flex justify-center w-full p-3 m-5 font-bold rounded-md text-16'>당류</div>
                            <hr></hr>
                            <div className='flex justify-center'>
                                {sugars.map((name, idx) => (
                                    <span className='m-5 text-center text-info_s w-[50%]' key={idx}>{name}g</span>
                ...
                <button onClick={handleComparisonView} className='flex justify-center m-auto my-10 rounded-[10px] w-270 h-30 bg-main text-[white] text-20 font-bold'>
                    확인
                </button>
            </div>
        </div>
