...
export default function FooterMain() {
	return (
		<div className='flex w-full my-20 bg-g100'>
			<div className='flex flex-col justify-center w-auto'>
				<h1 className='text-20 text-bold text-g700'>(주)식탐</h1>
				<div className='flex my-5 text-16'>
					<h3 className='m-5 text-g500'>개발진</h3>
					<span className='m-5 text-g400'>임동훈 박주혁 한주형</span>
				</div>
				<div className='flex my-5 text-16'>
					<h3 className='m-5 text-g500'>이메일</h3>
					<span className='m-5 text-g400'>wngud4950@gmail.com</span>
				</div>
				<div className='flex my-5 text-16'>
